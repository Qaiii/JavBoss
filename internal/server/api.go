...
func RegisterRoutes(router gin.IRoutes) {
	...
	router.GET("/jav/idols/:id/poster-options", listJavIdolPosterOptions)
	router.PUT("/jav/idols/:id/poster", updateJavIdolPoster)
	router.POST("/jav/idols/:id/poster", uploadJavIdolPoster)
	router.GET("/jav/idols/:id/poster/:name", getJavIdolPoster)
