...
func TestListVideosSortByDurationDirections(t *testing.T) {
	...
	items, err := ListVideos(ctx, 20, 0, nil, "", "duration", nil, nil, nil, nil)
	if err != nil {
	...
	items, err = ListVideos(ctx, 20, 0, nil, "", "duration_asc", nil, nil, nil, nil)
	if err != nil {
...
func TestListVideosCanHideRecognizedJav(t *testing.T) {
	...
	defaultItems, err := ListVideos(ctx, 20, 0, nil, "", "recent", nil, nil, nil, nil)
	if err != nil {
	...
	defaultCount, err := CountVideos(ctx, nil, "", nil, nil, nil)
	if err != nil {
	...
	defaultTags, err := ListTags(ctx, nil, nil, nil)
	if err != nil {
	...
	hiddenItems, err := ListVideos(ctx, 20, 0, nil, "", "recent", nil, nil, nil, nil, true)
	if err != nil {
	...
	hiddenCount, err := CountVideos(ctx, nil, "", nil, nil, nil, true)
	if err != nil {
	...
	hiddenTags, err := ListTags(ctx, nil, nil, nil, true)
	if err != nil {
...
func TestVideoLocationsAllowSameVideoInMultipleDirectories(t *testing.T) {
	...
	items, err := ListVideos(ctx, 20, 0, nil, "", "recent", nil, nil, nil, nil)
	if err != nil {
	...
	count, err := CountVideos(ctx, nil, "", nil, nil, nil)
	if err != nil {
	...
	dirBItems, err := ListVideos(ctx, 20, 0, nil, "", "recent", nil, []int64{dirB.ID}, nil, nil)
	if err != nil {
	...
	dirBCount, err := CountVideos(ctx, nil, "", []int64{dirB.ID}, nil, nil)
	if err != nil {
	...
	pathSearchItems, err := ListVideos(ctx, 20, 0, nil, "copies", "recent", nil, nil, nil, nil)
	if err != nil {
	...
	filenameSearchItems, err := ListVideos(ctx, 20, 0, nil, "movie.mp4", "recent", nil, nil, nil, nil)
	if err != nil {
	...
	disabledItems, err := ListVideos(ctx, 20, 0, nil, "", "recent", nil, []int64{0}, nil, nil)
	if err != nil {
	...
	disabledCount, err := CountVideos(ctx, nil, "", []int64{0}, nil, nil)
	if err != nil {
