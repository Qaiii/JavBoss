...
export default function VideoSettingsModal({
  ...
  return (
    <ModalShell
      open={open}
      onClose={onClose}
      title={zh('视频设置', 'Video Settings')}
      closeLabel={zh('关闭设置', 'Close settings')}
      panelClassName="w-full max-w-sm rounded-lg bg-white p-3 shadow-xl"
      headerClassName="mb-2 flex items-center justify-between gap-4"
    >
