...
export default function JavSettingsModal({
  ...
  return (
    <ModalShell
      ...
      backdropClassName="bg-slate-900/20 backdrop-blur-sm px-4 py-4"
      panelClassName="flex h-[860px] max-h-[94vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-white/80 bg-slate-50 shadow-2xl shadow-slate-900/20"
      headerClassName="flex shrink-0 items-center justify-between px-5 pb-3 pt-5"
      titleClassName="text-xl font-bold tracking-tight text-slate-900"
      titleId="jav-display-settings-title"
      panelRole
    >
