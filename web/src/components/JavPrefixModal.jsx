...
export default function JavPrefixModal({
  ...
  return createPortal(
    <ModalShell
      ...
      subtitle={zh('点击番号查询对应影片', 'Select a code to filter matching works')}
      closeLabel={zh('关闭', 'Close')}
      panelClassName="flex max-h-[86vh] w-full max-w-4xl flex-col rounded-lg bg-white shadow-xl"
      headerClassName="flex items-center justify-between border-b px-5 py-4"
      titleClassName="text-lg font-semibold text-gray-900"
      subtitleClassName="mt-1 text-xs text-gray-500"
      titleId="jav-prefix-modal-title"
      panelRole
    >
